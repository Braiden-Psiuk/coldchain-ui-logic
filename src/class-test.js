...
const dummyPalletUpdateInterval = 5000; // Fake pallet refresh interval in milliseconds
const moveOutChance = 2; // Chance that a dummy pallet will be moved out of refrigeration (an integer-based percentage, from 0% to 100%)
const outTime = 10000; // Amount of time in milliseconds that must pass before a dummy pallet is "moved back in" to refrigeration
